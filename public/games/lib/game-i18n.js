(() => {
  ...
  const EN = {
    ...
    '钢铁防线': 'Iron Defense', '3D 坦克大战': '3D TANK BATTLE', '3D 坦克大战 · 守卫基地': '3D TANK BATTLE · DEFEND THE BASE',
    '守住基地，击退一波又一波来袭装甲。': 'Defend the base against waves of incoming armor.',
    '单人': 'Solo', '双人': 'Two Players', '开始战斗': 'Start Battle', '查看规则': 'View Rules', '收起规则': 'Hide Rules', '退出游戏': 'Exit Game',
    '上一关': 'Previous stage', '下一关': 'Next stage', '快速选择关卡': 'Quick stage selection',
    ...
    '四方飞行棋 · 竞速云端': 'FOUR-WAY AERIAL RACE',
    '你执红方 · 朱雀': 'You are Red · Vermilion Bird',
    '从画面下方基地起飞': 'Take off from the base at the bottom of the board',
    '选择本局玩家数量': 'Choose Player Count', '核心规则': 'Core Rules',
    '掷中即可起飞': 'Roll to take off', '可以再掷一次': 'Roll again', '4 架': '4 planes', '率先到家获胜': 'First home wins',
    '开始竞速': 'Start Race', '查看完整规则': 'View Full Rules', '退出游戏': 'Exit Game',
